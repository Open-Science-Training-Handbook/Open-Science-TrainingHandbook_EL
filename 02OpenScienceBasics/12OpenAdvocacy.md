...
Το ΣΜΕΡΧ είναι ένας τρόπος για να σου υπενθυμίζει ότι οι στόχοι σου πρέπει να:
...
**Χ**χρονικά προσδιορισμένοι — και πρέπει να έχουν ολοκληρωθεί και επιτευχθεί μέσα σε ένα συγκεκριμένο χρονικό πλαίσιο.
